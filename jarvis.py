...
def wishme():
    print("Welcome back Mr.DAB!!")
    speak("Welcome back Mr.DAB!!")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "time" in query:
            ...
            speak("I'm JARVIS created by Mr. DAB and I'm a desktop voice assistant.")
            print("I'm JARVIS created by Mr. DAB and I'm a desktop voice assistant.")
